...
class Database(object):
    def __init__(self, host='ecshop.itsoso.cn', port=3306, charset='utf8'):
        self.cnn = pymysql.connect(user='ecshop', password='ecshop', database='ecshop', host='ecshop.itsoso.cn', port=3306,
                                   charset='utf8')
